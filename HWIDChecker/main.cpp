...
std::vector<std::string> getGraphicsCardInfo()
{
    ...
    for (UINT i = 0; ; ++i)
    {
        ...
        std::string strCardString = std::string(sCardName.begin(), sCardName.end());
        std::cout << "Test LUID Hight:" << AdapterDesc.AdapterLuid.HighPart
            << " Low:" << AdapterDesc.AdapterLuid.LowPart << "\n";

        vGraphicsCards.push_back(strCardString); //NVIDIA GeForce RTX 4070 Laptop GPU
    }
